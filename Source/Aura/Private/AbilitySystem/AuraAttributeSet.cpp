...
void UAuraAttributeSet::GetLifetimeReplicatedProps(TArray<FLifetimeProperty>& OutLifetimeProps) const
{
	...
	* Vital Attributes
	*/
	// Set health to replicate with no conditions. Always replicate even if value hasn't changed
...
{
	GAMEPLAYATTRIBUTE_REPNOTIFY(UAuraAttributeSet, CriticalResistance, OldCriticalHitResistance);
}
